...
The last comment does not include the filenames.
Do not include parts of the example in your comments.
It is given only as an example of approproate comments. `,
...
// Generate embeddings for the summary of the code snippet 
